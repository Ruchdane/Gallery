            ...
            <div class="d-flex justify-content-between mb-3 py-3">
                <div class="d-flex">
                    <button
                        ...
                        type="button"
                        class={
                            "btn btn-outline-" + settings.colorOutline + " mx-1"
                        }
                        onclick={() => {
                            vnode.attrs.set(0);
                        }}>
                ...
                {vnode.state.inputOn ? (
                    <input
                        ...
                        onchange={(e) => {
                            vnode.attrs.set(
                                rounded(e.target.value - 1, vnode.attrs.total)
                            );
                ...
                <div
                    ...
                    onclick={
                        /.(jpg|png|gif|jpeg)$/.test(vnode.attrs.media.src)
                            ? (e) => {
                                  const step =
                                      e.x > e.target.scrollWidth / 2 ? 1 : -1;
                                  vnode.attrs.set(
                                      rounded(
                                          vnode.attrs.index + step,
                                          vnode.attrs.total
                                      )
                                  );
                              }
        ...
        return (
            <div>
                <div class="swiper">
                    <div
                        class={
                            "swiper-wrapper d-flex justify-content-center" +
                            vnode.attrs.class
                        }>
                        {vnode.attrs.values.map((value, id) => (
